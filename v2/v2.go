...
func (a *APIv2) GetVersion() string {
	return a.Version
}
func (v *APIv2) ConnectDB() {
	v.Collection = helper.ConnectDBV2()
}

func (v *APIv2) ConnectDataDB() {
	v.DataCollection = helper.ConnectDBDataV2()
}

func (v *APIv2) GetCollection() *mongo.Collection {
	return v.Collection
}

func (v *APIv2) GetDataCollection() *mongo.Collection {
	return v.DataCollection
}

func (a *APIv2) GetUsers(w http.ResponseWriter, r *http.Request) {
...
func (a *APIv2) AddUserKey(w http.ResponseWriter, r *http.Request) {
	watch := stopwatch.Start()
...
func (a *APIv2) GetUser(w http.ResponseWriter, r *http.Request) {
	// set header.
	watch := stopwatch.Start()
...
func (a *APIv2) AddData(w http.ResponseWriter, r *http.Request) {
	watch := stopwatch.Start()
